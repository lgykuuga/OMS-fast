...
import com.lgy.common.enums.BusinessStatus;
import com.lgy.common.json.JSON;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.lgy.common.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            log.info(operLog.toString() + "return result:" + jsonResult);
        } catch (Exception exp) {
            // 记录本地异常日志
            log.error("==前置通知异常==");
