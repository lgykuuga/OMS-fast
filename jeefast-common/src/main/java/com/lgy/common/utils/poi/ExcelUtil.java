package com.lgy.common.utils.poi;
...
import com.lgy.common.annotation.Excels;
import com.lgy.common.annotation.Excel.ColumnType;
import com.lgy.common.annotation.Excel.Type;
...
public class ExcelUtil<T> {
     ...
     * @return
     */
    public static boolean checkIsSame(Set<String> set, String value, int setSize){
        set.add(value);
        if(set.size() == setSize){
            return false;
        }
