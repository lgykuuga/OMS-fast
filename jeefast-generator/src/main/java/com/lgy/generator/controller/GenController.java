package com.lgy.generator.controller;
...
import com.lgy.generator.service.IGenTableColumnService;
...
import com.lgy.common.utils.security.PermissionUtils;
...
public class GenController extends BaseController {
    ...
    private void genCode(HttpServletResponse response, byte[] data) throws IOException {
        response.reset();
        response.setHeader("Content-Disposition", "attachment; filename=\"lgy.zip\"");
