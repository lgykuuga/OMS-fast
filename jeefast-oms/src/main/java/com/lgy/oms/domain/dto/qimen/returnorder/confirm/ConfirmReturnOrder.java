package com.lgy.oms.domain.dto.qimen.returnorder.confirm;
...
public class ConfirmReturnOrder {
     ...
     * 发件人信息
     */
    private ConfirmReturnOrderSenderInfo senderInfo;
    ...
    public ConfirmReturnOrderSenderInfo getSenderInfo() {
        return senderInfo;
    }

    public void setSenderInfo(ConfirmReturnOrderSenderInfo senderInfo) {
